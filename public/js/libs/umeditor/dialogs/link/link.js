(function(){
    ...
    UM.registerWidget('link', {
        tpl: "<style type=\"text/css\">" +
            ".edui-dialog-link .edui-link-table{font-size: 14px;margin: 10px;line-height: 30px}" +
            ".edui-dialog-link .edui-link-txt{width:300px;height:31px;line-height:31px;border:1px solid #d7d7d7;}" +
            "</style>" +
