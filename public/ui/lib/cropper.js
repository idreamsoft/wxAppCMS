(function(factory) {
    ...
    var Croper = (function() {
        ...
        var options = {
            ...
            aspectRatio: _options.aspectRatio,
            dragMode: "move",
            // responsive: false,
            // zoomOnWheel: false,
            minCropBoxWidth: _options.width,
            minCropBoxHeight: _options.height,
            //zoomable: false,
            // scalable: false,
            // rotatable: false,
            // movable: false,
            ...
            ready: function(e) {
                ...
                CropBoxData.width = _options.width;
                CropBoxData.height = _options.height;
        ...
        btn.on('click', function() {
            ...
            $image.cropper('getCroppedCanvas').toBlob(function(blob) {
                ...
                formData.append('pg', _options.pg);
